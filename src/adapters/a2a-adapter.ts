...
// Wraps A2AClient for network I/O and maps between Tavori's AgentTask/AgentResult
...
export class A2AAdapter implements IAdapter {
  ...
  async execute(task: AgentTask): Promise<AgentResult> {
    ...
    // Build A2A message from Tavori's prompt
  ...
  // ─── Private: map A2A Task to Tavori AgentResult ───
      ...
      case "auth-required":
        return {
          ...
          error:
            ...
            "Tavori does not support interactive input through adapters.",
          exit_code: null,
          elapsed_ms: elapsed,
          stopped_reason: "error",
        };
