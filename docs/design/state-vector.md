...
When a milestone's deadline is reached, Tavori automatically runs the following evaluation.
...
Rescheduling decisions are proposed to the user and require approval, rather than being made autonomously by Tavori. Milestones were agreed upon in goal negotiation, and unilateral changes would damage trust.
