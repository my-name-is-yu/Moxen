...
**Purpose of learning**: Tavori may pursue the same goal multiple times. Without learning, it would repeat the same mistakes every time. The learning pipeline is the mechanism to "put accumulated experience to use in the next loop."
